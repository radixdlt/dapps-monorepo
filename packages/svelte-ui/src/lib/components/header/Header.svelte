<script lang="ts">
	...
	import { isMobile } from '../../../../../common/src/utils/device.js';
...
<header>
	<div class="logo-wrapper">
		<button on:click style={`background-image: url(${MenuIcon});`} class="mobile-menu" />
		<slot name="logo" />
		...
		<div class="mobile-only mobile-dapps-dropdown"><DappsDropdown {currentNetworkId} /></div>
	</div>
	{#if !hideSearch} <div class="search"><NetworkLookupSearch /></div> {/if}
	<div class="right-wrapper">
		<div class="desktop-only">
			<DappsDropdown {currentNetworkId} />
		</div>
